...
class TestRunnerTool(Tool):
    ...
    #: Without this, pytest tries to collect this class as a test case.
    __test__ = False
    ...
    def risk_for(self, arguments: dict[str, Any]) -> ToolRisk:
        """Auto-detected test commands run the project's tests; a caller-supplied
        command is run through a shell, which is the same power as ``shell``."""
