...
- Skills are stored as markdown files in ~/.utopia/skills/
...
from utopia_agent.skills.skill import Skill
...
class SkillManager:
    ...
    def __init__(self, skills_dir: str | Path | None = None) -> None:
        self.skills_dir = Path(skills_dir).expanduser() if skills_dir else Path("~/.utopia/skills").expanduser()
