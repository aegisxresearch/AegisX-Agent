...
#: A GET only reads; a DELETE on a remote resource cannot be undone.
_METHOD_RISKS: dict[str, ToolRisk] = {
    "GET": ToolRisk.SAFE,
    "POST": ToolRisk.CAUTION,
    "PUT": ToolRisk.CAUTION,
    "PATCH": ToolRisk.CAUTION,
...
class APICallerTool(Tool):
    ...
    def risk_for(self, arguments: dict[str, Any]) -> ToolRisk:
        """Risk follows the HTTP method, not the URL."""
        method = str(arguments.get("method", "GET")).upper()
        return _METHOD_RISKS.get(method, ToolRisk.DANGEROUS)
